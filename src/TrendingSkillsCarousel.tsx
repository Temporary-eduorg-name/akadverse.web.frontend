            ...
            >
              {skills.map((skill) => (
                <SwiperSlide key={skill.id}>
                  <div
                    className="relative bg-white dark:bg-zinc-900 rounded-lg shadow-lg overflow-hidden border border-zinc-200 dark:border-zinc-700 hover:shadow-xl transition-shadow cursor-pointer h-full"
                  ...
                  >
                    ...
                    <div className="relative">
                      {skill.profilePicture ? (
                        ...
                        <div className="w-full h-48 bg-gradient-to-br from-orange-200 to-red-300 dark:from-orange-900 dark:to-red-900 flex items-center justify-center">
                      ...
                      {/* Visitors Count */}
                      <div className="absolute bottom-2 right-2 bg-white/90 dark:bg-zinc-800/90 text-zinc-900 dark:text-white px-3 py-1 rounded-full text-xs font-semibold">
                        👁️ {skill.visitors} views
                      </div>
