...
const tabItems: TabItem[] = [
  ...
  },
  {
    ...
    icon: Calculator,
    path: "/studashboard/e-learning/academic-records/cgpa-calculator",
  },
  {
    id: "records",
    label: "Academic Records",
    icon: FileText,
    path: "/studashboard/e-learning/academic-records/results",
  },
  {
    id: "assessment",
    label: "Academic Assessment",
    icon: ClipboardCheck,
    path: "/studashboard/e-learning/academic-records/assessment",
  },
  {
    id: "documentation",
    label: "Document Upload",
    icon: FileUp,
    path: "/studashboard/e-learning/academic-records/documentation",
  },
];
