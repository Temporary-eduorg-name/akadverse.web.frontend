...
const DashboardSidebar = ({ collapsed = false, className = '', onWidthChange }: DashboardSidebarProps) => {
  ...
  const [essentialsExpanded, setEssentialsExpanded] = useState(pathname.startsWith('/admindashboard/main-menu/essentials'));
  ...
  const navItems = [
    ...
    { id: 'marketplace', label: 'Marketplace', icon: BookOpen, path: '/admindashboard/main-menu/marketplace', subItems: null },
    {
      ...
      subItems: [
        ...
        { id: 'schedule', label: 'Schedule Manager', icon: Calendar, path: '/admindashboard/main-menu/essentials/schedule-manager' },
        { id: 'attendance', label: 'Attendance', icon: CheckCircle, path: '/admindashboard/main-menu/essentials/attendance' },
        { id: 'suggestions', label: 'Suggestions', icon: Lightbulb, path: '/admindashboard/main-menu/essentials/suggestions' },
      ],
    },
  ];
