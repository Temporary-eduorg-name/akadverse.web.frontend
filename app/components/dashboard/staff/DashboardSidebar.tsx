...
const DashboardSidebar = ({ collapsed = false, className = '', onWidthChange }: DashboardSidebarProps) => {
  ...
  const [essentialsExpanded, setEssentialsExpanded] = useState(pathname.startsWith('/staffdashboard/main-menu/essentials'));
  ...
  const navItems = [
    { id: 'dashboard', label: 'Faculty Dashboard', icon: LayoutDashboard, path: '/staffdashboard/main-menu/faculty-dashboard', subItems: null },
    { id: 'marketplace', label: 'Marketplace', icon: BookOpen, path: '/staffdashboard/main-menu/marketplace', subItems: null },
    {
      id: 'essentials',
      label: 'Faculty Essentials',
      icon: Folder,
      path: null,
      subItems: [
        { id: 'email', label: 'Email', icon: Mail, path: '/staffdashboard/main-menu/essentials/email' },
        { id: 'schedule', label: 'Schedule Manager', icon: Calendar, path: '/staffdashboard/main-menu/essentials/schedule-manager' },
        { id: 'attendance', label: 'Attendance', icon: CheckCircle, path: '/staffdashboard/main-menu/essentials/attendance' },
        { id: 'suggestions', label: 'Suggestions', icon: Lightbulb, path: '/staffdashboard/main-menu/essentials/suggestions' },
      ],
    },
  ];
  ...
  const isEssentialsSectionActive = pathname.startsWith('/staffdashboard/main-menu/essentials');
  const compactItems = [
    { id: 'dashboard', icon: LayoutDashboard, path: '/staffdashboard/main-menu/faculty-dashboard' },
    { id: 'marketplace', icon: BookOpen, path: '/staffdashboard/main-menu/marketplace' },
    { id: 'essentials', icon: Folder, path: '/staffdashboard/main-menu/essentials/suggestions' },
  ];
  const mobileItems = [
    { id: 'dashboard', label: 'Home', icon: LayoutDashboard, path: '/staffdashboard/main-menu/faculty-dashboard' },
    { id: 'marketplace', label: 'Market', icon: BookOpen, path: '/staffdashboard/main-menu/marketplace' },
    { id: 'email', label: 'Email', icon: Mail, path: '/staffdashboard/main-menu/essentials/email' },
    { id: 'schedule', label: 'Schedule', icon: Calendar, path: '/staffdashboard/main-menu/essentials/schedule-manager' },
    { id: 'attendance', label: 'Attendance', icon: CheckCircle, path: '/staffdashboard/main-menu/essentials/attendance' },
    { id: 'suggestions', label: 'Ideas', icon: Lightbulb, path: '/staffdashboard/main-menu/essentials/suggestions' },
  ];
  ...
  return (
    <>
      ...
      <div className={sidebarCollapsed ? 'flex justify-center pt-2 pb-1' : 'relative flex items-center justify-end px-4 pt-3 pb-2'}>
        ...
        <motion.button
          whileTap={{ scale: 0.96 }}
          className="h-8 w-8 rounded-[10px] border-2 border-[#d1d9e6] bg-white text-[#8492a6] hover:text-[#667eea] hover:border-[#667eea] flex items-center justify-center shadow-[0_2px_12px_rgba(15,23,42,0.1)] transition-colors duration-200"
