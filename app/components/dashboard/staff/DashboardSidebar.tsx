...
const mainMenuNavItems: NavItem[] = [
  ...
  },
  {
    ...
    label: "Marketplace",
    icon: BookOpen,
    path: "/staffdashboard/main-menu/marketplace",
  },
  {
    id: "essentials",
    ...
    subItems: [
      {
        ...
        label: "Email",
        icon: Mail,
        path: "/staffdashboard/main-menu/essentials/email",
      },
      {
        id: "schedule",
        label: "Schedule Manager",
        icon: Calendar,
        path: "/staffdashboard/main-menu/essentials/schedule-manager",
      },
      {
        id: "attendance",
        label: "Attendance",
        icon: CheckCircle,
        path: "/staffdashboard/main-menu/essentials/attendance",
      },
      {
        id: "suggestions",
        label: "Suggestions",
        icon: Lightbulb,
        path: "/staffdashboard/main-menu/essentials/suggestions",
      },
    ],
  },
];
...
const eLearningNavItems: NavItem[] = [
  {
    ...
    label: "Faculty Dashboard",
    icon: LayoutDashboard,
    path: "/staffdashboard/e-learning/my-learning",
  },
  {
    id: "faculty-essentials",
    label: "Faculty Essentials",
    icon: Folder,
    subItems: [
      {
        ...
        icon: BookOpen,
        path: "/staffdashboard/e-learning/faculty-essentials/course-control",
      },
      {
        id: "academic-records",
        label: "Academic Records",
        icon: FileText,
        path: "/staffdashboard/e-learning/faculty-essentials/academic-records",
      },
    ],
  },
  {
    ...
    icon: Library,
    path: "/staffdashboard/e-learning/faculty-resources",
  },
];
...
export default function DashboardSidebar({
  ...
  const isELearningContext = pathname.startsWith("/staffdashboard/e-learning");
  const [essentialsExpanded, setEssentialsExpanded] = useState(
    pathname.startsWith("/staffdashboard/main-menu/essentials"),
  );
  const [learningEssentialsExpanded, setLearningEssentialsExpanded] = useState(
      pathname.startsWith(
        "/staffdashboard/e-learning/faculty-essentials/course-control",
      ) ||
      pathname.startsWith(
        "/staffdashboard/e-learning/faculty-essentials/academic-records",
      ) ||
      pathname.startsWith("/staffdashboard/e-learning/academic-records") ||
      pathname.startsWith("/staffdashboard/e-learning/faculty-resources"),
  );
  ...
  useEffect(() => {
    if (pathname.startsWith("/staffdashboard/main-menu/essentials")) {
  ...
  if (collapsed) {
    return (
      <div
        className={`fixed bottom-0 left-0 right-0 top-auto z-30 h-16 w-auto border-t border-gray-200 bg-white ${
          desktopSticky
            ? "lg:sticky lg:bottom-auto lg:left-auto lg:right-auto lg:top-[70px]"
            : "lg:fixed lg:bottom-auto lg:left-0 lg:right-auto lg:top-[70px]"
  ...
  return (
    <>
      <nav
        className={`fixed bottom-0 left-0 right-0 z-30 h-16 border-t border-gray-200 bg-white lg:hidden ${className}`}
      >
      ...
      <motion.aside
        ...
        className={`hidden overflow-hidden border-r border-gray-200 bg-white z-30 lg:flex lg:h-[calc(100vh-70px)] lg:flex-col ${
          desktopSticky ? "sticky top-[70px] self-start" : "fixed left-0 top-[70px]"
        } ${className}`}
      >
        <div
          className={
