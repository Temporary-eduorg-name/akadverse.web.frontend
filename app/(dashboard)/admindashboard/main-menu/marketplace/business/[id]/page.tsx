...
import ProductsPage from "@/src/businessPages/ProductPage";
import AnalyticsComponent from "@/src/businessPages/AnalyticsComponent";
import OrdersComponent from "@/src/businessPages/OrdersComponent";
import ReviewsComponent from "@/src/businessPages/ReviewsComponent";
import NotificationsComponent from "@/src/businessPages/NotificationsComponent";
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mt-4">Loading business dashboard...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <Link href="/admindashboard/main-menu/marketplace" className="text-blue-600 hover:underline">
            Back to Dashboard
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-black">
      ...
      <div className="bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 px-4 py-6">
        <div className="max-w-7xl mx-auto flex justify-between items-start">
          ...
          <Link
            href={`/admindashboard/main-menu/marketplace/business/${businessId}/edit`}
