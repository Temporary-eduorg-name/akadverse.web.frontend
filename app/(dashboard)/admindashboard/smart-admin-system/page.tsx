  ...
  return (
    <div className="min-h-screen bg-white font-sans">
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex w-full items-center justify-between gap-4 sm:gap-6 md:w-auto md:justify-normal">
            ...
            <div className="flex items-center gap-2">
              <span className="hidden text-sm font-medium text-gray-900 sm:inline">Admin Profile</span>
              <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                <User size={16} className="text-blue-600" />
              </div>
            </div>
            <button className="text-gray-400 hover:text-gray-600 transition-colors" onClick={() => router.push('/login')}>
              <LogOut size={18} />
            </button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 sm:py-8">
        <button onClick={() => router.back()} className="mb-6 flex items-center gap-2 text-gray-600 transition-colors hover:text-gray-900 sm:mb-8">
          <ArrowLeft size={20} />
          <span className="text-sm font-medium">Back</span>
        </button>

        <div className="mb-8 sm:mb-12">
          <h1 className="mb-2 text-3xl font-bold text-gray-900 sm:text-4xl">Smart Admin System</h1>
          <p className="text-gray-600">Institutional Intelligence, KPIs, and advanced analytics.</p>
        </div>

        <div className="flex min-h-[320px] items-center justify-center sm:min-h-[400px]">
          <div className="text-center">
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Coming Soon</h2>
            <p className="text-gray-600">Smart admin features are under development.</p>
          </div>
        </div>
      </div>
    </div>
