          ...
          <div className="flex gap-6">
                ...
                <div className="flex items-center gap-6">
                  <div className="relative w-28 h-28 flex-shrink-0">
                    <svg viewBox="0 0 100 100" className="w-full h-full -rotate-90">
                      ...
                      <circle
                        cx="50" cy="50" r="38" fill="none" stroke="#1e40af" strokeWidth="12"
                  ...
                  <div className="flex-1">
                    <div className="mb-3">
                      <div className="flex justify-between text-xs text-gray-500 mb-1">
                        <span>Credit Progress</span><span>78%</span>
                      </div>
                    ...
                    <div className="flex gap-6">
                      <div><p className="text-xs text-gray-500">Status</p><p className="text-sm font-semibold text-emerald-600">Distinction</p></div>
                      <div><p className="text-xs text-gray-500">Remaining</p><p className="text-sm font-semibold text-gray-800">26 Credits</p></div>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      {courses.map((course, idx) => (
                        <tr key={idx} className="border-b border-gray-50 last:border-0">
                          ...
                          <td className="py-3 pr-4">
                            <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${course.status === 'Completed' ? 'bg-emerald-50 text-emerald-600' : 'bg-teal-50 text-teal-600'}`}>
                              {course.status}
                            </span>
                          </td>
                          <td className="py-3">
            ...
            <div className="w-[274px] flex-shrink-0 flex flex-col gap-4">
              ...
              <div className="bg-[#1e40af] rounded-2xl p-5 text-white">
                ...
                <p className="text-xs text-white/70 mb-4">Personalized courses and resources based on your performance.</p>
