                            ...
                            <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className={`rounded-lg px-4 py-2 text-sm font-semibold transition-colors ${activeTab === 'disputes'
                                    ...
                                    <button
                                        ...
                                        className={`rounded-lg px-4 py-2 text-sm font-semibold transition-colors ${activeTab === 'suggestions'
                                                ? 'bg-[#667eea] text-white'
                                                : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                            }`}
                                    >
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex gap-2 flex-wrap">
                                        <button
                                            ...
                                            className={`rounded-lg px-4 py-2 text-sm font-semibold transition-colors ${activeDisputeTab === 'all' ? 'bg-[#667eea] text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                                }`}
                                        >
                                            All ({disputes.length})
                                        </button>
                                        <button
                                            ...
                                            className={`rounded-lg px-4 py-2 text-sm font-semibold transition-colors ${activeDisputeTab === 'orders' ? 'bg-amber-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                                }`}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`rounded-lg px-4 py-2 text-sm font-semibold transition-colors ${activeDisputeTab === 'offers' ? 'bg-orange-500 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                                                }`}
                                        >
                                                ...
                                                {visibleDisputes.map((item) => (
                                                    <div key={`${item.type}-${item.id}`} className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                                                        <div className="flex flex-wrap items-start justify-between gap-3">
                                                            <div>
                                                                <div className="flex items-center gap-2 mb-1">
                                                                    ...
                                                                    <span
                                                                        className={`rounded-full px-2.5 py-0.5 text-xs font-semibold ${item.type === 'order'
                                                        ...
                                                        <div className="mt-2 text-xs text-gray-500 flex flex-wrap gap-4">
                                                            <span>Amount: 
6{item.totalAmount.toLocaleString()}</span>
