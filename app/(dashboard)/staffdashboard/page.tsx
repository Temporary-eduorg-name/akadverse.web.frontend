  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <div className="border-b border-gray-200 bg-white sticky top-0 z-40">
        <div className="px-6 py-4 grid grid-cols-3 items-center">
          ...
          <div className="justify-self-center">
            <span className="text-sm font-medium text-gray-400 tracking-wide">Faculty Workspace</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Good morning, Faculty</h1>
