  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Courses & Resources</h1>
          <p className="text-gray-600">Manage course content, lecture materials, and teaching resources.</p>
        </div>
