...
export default function EditBusinessPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push(`/staffdashboard/main-menu/marketplace/dashboard/business/${businessId}`);
      }, 2000);
    } catch (err) {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <Link href="/staffdashboard/main-menu/marketplace/dashboard" className="text-blue-600 hover:underline">
            Back to Dashboard
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <Link href={`/staffdashboard/main-menu/marketplace/dashboard/business/${businessId}`} className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white mb-6 inline-block">
          ← Back
        </Link>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-4 pt-6">
              ...
              <Link
                href={`/staffdashboard/main-menu/marketplace/dashboard/business/${businessId}`}
