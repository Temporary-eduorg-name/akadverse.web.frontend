...
export default function DashboardPage() {
  ...
  const fetchStats = async () => {
    try {
      ...
      const statsResponse = await fetch(`/api/marketplace/dashboard/stats?${queryParams}`, {
        method: "GET",
        credentials: "include",
      });
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div>
          <div className="flex justify-between items-center mb-6">
            ...
            <Link
              href="/staffdashboard/main-menu/marketplace/add-business"
          ...
          {businesses.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {businesses.map((business) => (
                <Link
                  key={business.id}
                  href={`/staffdashboard/main-menu/marketplace/dashboard/business/${business.id}`}
