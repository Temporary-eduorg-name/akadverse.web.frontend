                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-xs text-zinc-500 dark:text-zinc-400 mb-1">
                      By: <Link href={`/studashboard/main-menu/marketplace/business/${product.business.id}`} className="hover:underline text-zinc-700 dark:text-zinc-300 font-medium" onClick={(e) => e.stopPropagation()}>{product.business.name}</Link>
                    </p>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {skills.map((skill) => (
                <Link
                  key={skill.id}
                  href={`/studashboard/main-menu/marketplace/dashboard/skills/${skill.id}`}
                  className="bg-white dark:bg-zinc-900 rounded-lg shadow-lg overflow-hidden border border-zinc-200 dark:border-zinc-700 hover:shadow-xl transition-shadow"
                >
                  {/* Profile Picture */}
