...
export default function SkillsDashboardMainPage() {
    ...
    const fetchSkillsData = async () => {
        try {
            const response = await fetch("/api/skills?type=my", {
                credentials: "include",
            });
    ...
    const fetchSkillStats = async () => {
        try {
            ...
            const response = await fetch(
                `/api/skills/dashboard/stats?${params}`,
                {
                    credentials: "include",
                }
            );
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex gap-2 border-b border-zinc-200 dark:border-zinc-700 overflow-x-auto">
                        {(["analytics", "offers", "manage"] as const).map(
                            (tab) => (
                                <button
                                    key={tab}
                                    ...
                                    skills.map((skill) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex gap-2">
                                                <Link
                                                    href={`/edit-skill/${skill.id}`}
                                                    className="flex-1 bg-blue-600 dark:bg-blue-500 text-white px-3 py-2 rounded text-sm font-semibold hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors text-center"
                                                >
                                                    Edit
                                                </Link>
                                                <button
                                                    ...
                                                    className="flex-1 bg-red-600 dark:bg-red-500 text-white px-3 py-2 rounded text-sm font-semibold hover:bg-red-700 dark:hover:bg-red-600 transition-colors"
                                                >
                                                    Delete
                                                </button>
                                            </div>
