        ...
        <div className="bg-zinc-100 rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 p-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {/* Starting Price */}
              <div>
                <label className="w-full px-3 py-2 border border-zinc-300 rounded-md bg-white text-zinc-900">
                  Starting Price (₦)
                </label>
                <select
                  value={startingPrice}
                ...
                <div className="flex flex-wrap gap-3">
                  {DAYS.map((day) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-lg font-medium transition-colors ${serviceDays.includes(day)
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-zinc-900 text-white px-6 py-3 rounded-lg font-semibold hover:bg-zinc-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
