...
const TEST_PREP_QUESTIONS: Question[] = [
  {
    id: 1,
    type: "multiple-choice",
    points: 5,
    text: "What is the primary objective of unit testing?",
    options: [
      "To test the entire application",
      "To verify that individual components work correctly in isolation",
      "To ensure the database is functioning",
  ...
  },
  {
    ...
    type: "multiple-choice",
    points: 5,
    text: "Which pattern ensures loose coupling between components?",
  ...
  },
  {
    ...
    options: [
      "Definitely Refactor Your code",
      "Don't Repeat Yourself",
      "Dynamic Resource Yieldism",
      "Deploy Really Yearning applications",
    ],
  },
  {
    id: 4,
    type: "theoretical",
    points: 8,
    text: "Explain how the Strategy pattern differs from the State pattern.",
  },
  {
    id: 5,
    type: "multiple-choice",
  ...
  },
  {
    ...
    type: "multiple-choice",
    points: 5,
    text: "What is the primary benefit of using interfaces in OOP?",
    options: [
      "To store data efficiently",
      "To define contracts for classes to implement",
  ...
  },
  {
    ...
    type: "essay",
    points: 6,
    text: "Describe how you would approach debugging a complex software issue in production.",
  },
];
...
export default function TestPreparationPage() {
  ...
  const currentQ = TEST_PREP_QUESTIONS[examState.currentQuestion];
  ...
  const navigateNext = () => {
    if (examState.currentQuestion < TEST_PREP_QUESTIONS.length - 1) {
      goToQuestion(examState.currentQuestion + 1);
    }
  };
  ...
  const totalPoints = TEST_PREP_QUESTIONS.reduce((sum, q) => sum + q.points, 0);
      ...
      <div className="flex min-h-full items-center justify-center bg-[#f5f6f7] px-4 py-8">
        <div className="max-w-md rounded-[18px] bg-white p-8 text-center shadow-sm">
          ...
          <p className="mb-6 text-[14px] text-[#6b7a94]">
            You answered {answeredCount} out of {TEST_PREP_QUESTIONS.length}{" "}
            questions.
          </p>
          <button
            type="button"
      ...
      <div className="hidden w-[180px] border-r-2 border-[#e5e9f3] bg-white px-4 py-6 lg:block">
        <div className="mb-4">
          <h3 className="mb-2 text-[11px] font-bold uppercase text-[#8d9ab1]">
            Questions ({answeredCount}/{TEST_PREP_QUESTIONS.length})
          </h3>
        </div>

        <div className="mb-6 grid grid-cols-5 gap-2">
          {TEST_PREP_QUESTIONS.map((q, idx) => {
            ...
            <div className="mx-auto w-full max-w-3xl">
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  disabled={
                    examState.currentQuestion === TEST_PREP_QUESTIONS.length - 1
                  }
                  className="flex items-center gap-2 rounded-[8px] border-2 border-[#e5e9f3] bg-white px-4 py-2 text-[13px] font-bold text-[#7a8a9f] transition hover:border-[#d8deea] disabled:opacity-50"
                >
                  Next
