...
const Page = () => {
  ...
  <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 sm:py-8">
        ...
        <div className="mb-8 sm:mb-12">
          <h1 className="mb-2 text-3xl font-bold text-gray-900 sm:text-4xl">My Learning</h1>
          <p className="text-gray-600">Access student courses, modules, and assignments.</p>
        </div>
        ...
        <div className="flex min-h-[320px] items-center justify-center sm:min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-gray-600">Course modules and assignments are under development.</p>
          </div>
        </div>
      </div>
    </div>
