...
const Page = () => {
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex w-full items-center justify-between gap-4 sm:gap-6 md:w-auto md:justify-normal">
            ...
            <div className="flex items-center gap-2">
              <span className="hidden text-sm font-medium text-gray-900 sm:inline">Student Profile</span>
  ...
  <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 sm:py-8">
        ...
        <div className="mb-8 sm:mb-12">
          <h1 className="mb-2 text-3xl font-bold text-gray-900 sm:text-4xl">Learning Resources</h1>
          <p className="text-gray-600">Library of lecture materials, PDFs, and recorded videos.</p>
        </div>
        ...
        <div className="flex min-h-[320px] items-center justify-center sm:min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-gray-600">Learning resources library is under development.</p>
          </div>
        </div>
      </div>
    </div>
