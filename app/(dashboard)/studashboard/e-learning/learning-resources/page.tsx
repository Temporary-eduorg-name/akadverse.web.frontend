  ...
  return (
    <div className="h-screen overflow-hidden bg-[#f8f9fc] font-sans">
      ...
      <div className="flex min-h-0" style={{ height: "calc(100vh - 70px)" }}>
        ...
        <main
          style={mainStyle}
          className="ml-0 min-w-0 flex-1 overflow-y-auto overflow-x-hidden bg-[#f8f9fc] p-6 transition-[margin] duration-300 ease-out lg:ml-[var(--sidebar-width)] lg:p-7"
        >
          <div className="relative w-full">
            <div className="pointer-events-none fixed inset-0 z-0 ml-0 lg:ml-[var(--sidebar-width)]">
              {[...Array(8)].map((_, index) => {
                const base = [
            ...
            <div className="relative z-10 w-full">
              ...
              <div className="mb-12 text-center">
                ...
                <p className="text-slate-500 text-lg">
                  Explore the world&apos;s best educational platforms in one
                  place.
                </p>
